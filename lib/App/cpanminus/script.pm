...
sub parse_options {
    ...
    Getopt::Long::GetOptions(
        ...
        'include-vendor!' => \$self->{include_vendor},
...
sub _core_only_inc {
    ...
    (
        ...
        ($self->{include_vendor} ? @Config{qw(vendorarch vendorlibexp)} : ()),
...
sub loaded_from_perl_lib {
    ...
    if ($self->{self_contained} && $self->{include_vendor}) {
        push @dirs, qw(vendorarch vendorlibexp);
    }
    for my $dir (@dirs) {
